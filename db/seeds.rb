...
spots = [
  ...
  {name:'Tobin School Graffiti Murals',location:'40 Smith St, Boston MA',location_lat:'42.3329557',location_lng:'-71.100527',description:'Graffiti murals at Tobin School.',remote_photo_url:'https://s3.amazonaws.com/arts-bostonia/arts-bostonia-production/rocknakpoepfo1.jpg',user:user_1},
  {name:'Abe Blinkin',location:'77 Summer St, Boston MA',location_lat:'',location_lng:'',description:'abe is the man',remote_photo_url:'http://www.talkingstatues.co.uk/stockist_images/chicagoadmin/530x1530_lincoln.jpg',user:user_1},
  {name:'Content from admin',location:'1 Cambridge Sq, Cambridge MA',location_lat:'',location_lng:'',description:'lorem ipsum dolum',user:admin}
]
