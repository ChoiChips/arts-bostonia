...
spots = [
  ...
  { name: 'Site of the First Bell of Boston', location:'19 N Square, Boston, Massachusetts, 02113', description: 'The first bell ever cast in Boston was cast by Paul Revere...and sounded terrible.', remote_photo_url: 'https://s3.amazonaws.com/arts-bostonia/arts-bostonia-production/bostonbell.jpg', user: user_1},
