...
feature 'index visit' do
  scenario "visitor sees spots displayed on index page and links to spots" do
    ...
    expect(page).to have_link('https://upload.wikimedia.org/wikipedia/commons/3/33/George_Washington_statue_in_the_Boston_Public_Garden_-_DSC08199.JPG')
