...
describe('SpotsIndexContainer', () => {
  ...
  beforeEach(() => {
    let spots = [
      ...
      { name: 'Sam Adams',location:'Boston Common, Boston MA',description: 'great beer', photo: '' },
      ...
      { name: 'Christian the Pirate',location:'Deck 7 Common, Boston MA',description: 'fastest eyes', photo: ''},
      { name: 'Evan the Great',location:'1 Cambridge Sq, Cambridge MA',description: 'lorem ipsum dolum', photo: '' }
    ]
